...
Contact4.defaultProps = {
  address1: 'ул. Пример, д.1, г. Примеровск',
  content4: 'Будем рады услышать ваши отзывы и предложения.',
  email1: 'example@example.com',
  content1: 'Мы всегда рады помочь вам!',
  heading1: 'Контакты',
  content3: 'Позвоните нам или напишите на почту.',
  content5: 'Ждем вашего звонка!',
  content2: 'Если у вас есть вопросы, не стесняйтесь обращаться к нам.',
