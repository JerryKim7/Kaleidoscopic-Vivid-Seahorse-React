...
Hero3.defaultProps = {
  action1: 'Поиск',
  content1: 'Каталог товаров',
  action2: 'Корзина',
  heading1: 'Добро пожаловать в наш магазин!',
  image1Alt: 'Изображение товара 1',
  image1Src:
    'https://images.unsplash.com/photo-1637566396443-c1ccbd0abd07?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcxNjgyMjg0OXw&ixlib=rb-4.0.3&q=80&w=1080',
}
